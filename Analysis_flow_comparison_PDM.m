...
flow_file="H:\01.PhD\004.Chapter4\Input_data_CEH\Observed Flows_eFlag\PDM\PDM_simobs_";
...
for i=1:length(GaugesNo)
    ...
    clf 
    set(gca,'Box','on');
    save_name=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM\Validate_flows\Obs_vs_sim_gauge_',no,'.png');
    ...
    save_name=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM\Validate_flows\Obs_vs_sim_R2_gauge_',no,'.png');
...
R_save_file='H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM\Validate_flows\R2_values_PDM';
