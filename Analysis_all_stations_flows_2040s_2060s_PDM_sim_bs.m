...
%% Read the baseline flows and save the 1990s flows in an Excel file
    Current_station_location_baseline=strcat('H:\01.PhD\004.Chapter4\Input_data_CEH\Observed Flows_eFlag\PDM\PDM_simobs_',no,'.csv');
    ...
    Flow_Obs_baseline=Current_station_baseline(:,3);
    Flow_Obs_baseline=table2array(Flow_Obs_baseline);
    
    %Check if file exists, if yes delete it
    if exist(strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Baseline\Baseline_station_',no,'.xls'), 'file')==2
        delete(strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Baseline\Baseline_station_',no,'.xls'));
    end
    writetable(Current_station_baseline,strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Baseline\Baseline_station_',no,'.xls'));

%% Read the future flows and save the 2040s future flows in an Excel file
    Current_station_future_2040s_location=strcat('H:\01.PhD\004.Chapter4\Input_data_CEH\Future Flow_eFlag\PDM\PDM_simrcm_',no,'.csv');
    ...
    %Check if file exists, if yes delete it
    if exist(strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2040s\Future_2040s_station_',no,'.xls'), 'file')==2
        delete(strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2040s\Future_flow_inputs\Future_2040s_station_',no,'.xls'));
    end
    writetable(Current_station_future_2040s,strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2040s\Future_2040s_station_',no,'.xls'));
    
%% Read the future flows and save the 2060s future flows in an Excel file
    Current_station_future_2060s_location=strcat('H:\01.PhD\004.Chapter4\Input_data_CEH\Future Flow_eFlag\PDM\PDM_simrcm_',no,'.csv');
    ...
    %Check if file exists, if yes delete it
    if exist(strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2060s\Future_2060s_station_',no,'.xls'), 'file')==2
        delete(strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2060s\Future_2060s_station_',no,'.xls'));
    end
    writetable(Current_station_future_2060s,strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2060s\Future_2060s_station_',no,'.xls'));

%% Plot the baseline flow vs 2040s flow for all RCMs
clf %clears figure information
       set(gca,'Box','on');
       hold on
       save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Baseline_vs_2040s_all_RCM_ID_',no,'.png');
       tiledlayout(2,1)
...
clf %clears figure information
       set(gca,'Box','on');
       save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Baseline_vs_2060s_all_RCM_ID_',no,'.png');
       tiledlayout(2,1)
...
clf %clears figure information
       ...
       hold on
       save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Daily_future_flows_2040s_RCM01_ID_',no,'.png');
...
clf %clears figure information
       ...
       set(gca,'Box','on','FontSize',9);
       hold on
       save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Daily_future_flows_2060s_RCM01_ID_',no,'.png');
...
clf 
set(gca,'Box','on');
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Baseline_vs_future_FDC_ID_',no,'.png');
...
clf 
set(gca,'Box','on');
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Baseline_vs_future_2040s_allRCMs_FDC_ID_',no,'.png');
title_name_baseline=strcat('Flow duration curves at station no.'," ",no);
title(title_name_baseline);
ylabel('Flows [m^3/s]');
xlabel('Exceeding probability [%]');
...
clf 
set(gca,'Box','on');
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Baseline_vs_future_2060s_allRCMs_FDC_ID_',no,'.png');
title_name_baseline=strcat('Flow duration curves at station no.'," ",no);
title(title_name_baseline);
ylabel('Flows [m^3/s]');
xlabel('Exceeding probability [%]');
...
if exist(strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Station_',no,'_flows_2040s_monthly_vs_baseline.xls'), 'file')==2
   delete(strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Station_',no,'_flows_2040s_monthly_vs_baseline.xls'));
end
 
xlswrite(strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Station_',no,'_flows_2040s_monthly_vs_baseline.xls'),Table_monthly,'Sheet1','A2');
xlswrite(strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Station_',no,'_flows_2040s_monthly_vs_baseline.xls'),Table_monthly_header,'Sheet1','A1');
...
clf %clears figure information
set(gca,'Box','on');       
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2040s\Monthly_mean_flows_diff_RCM01_ID_',no,'.png');
...
clf %clears figure information
set(gca,'Box','on');       
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2040s\Monthly_mean_flows_diff_RCM04_ID_',no,'.png');
...
clf %clears figure information
set(gca,'Box','on');       
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2040s\Monthly_mean_flows_diff_RCM05_ID_',no,'.png');
...
clf %clears figure information
set(gca,'Box','on');       
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2040s\Monthly_mean_flows_diff_RCM06_ID_',no,'.png');
...
clf %clears figure information
set(gca,'Box','on');       
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2040s\Monthly_mean_flows_diff_RCM07_ID_',no,'.png');
...
clf %clears figure information
set(gca,'Box','on');       
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2040s\Monthly_mean_flows_diff_RCM08_ID_',no,'.png');
...
clf %clears figure information
set(gca,'Box','on');       
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2040s\Monthly_mean_flows_diff_RCM09_ID_',no,'.png');
...
clf %clears figure information
set(gca,'Box','on');       
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2040s\Monthly_mean_flows_diff_RCM10_ID_',no,'.png');
...
clf %clears figure information
set(gca,'Box','on');       
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2040s\Monthly_mean_flows_diff_RCM11_ID_',no,'.png');
...
clf %clears figure information
set(gca,'Box','on');       
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2040s\Monthly_mean_flows_diff_RCM12_ID_',no,'.png');
...
clf %clears figure information
set(gca,'Box','on');       
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2040s\Monthly_mean_flows_diff_RCM13_ID_',no,'.png');
...
clf %clears figure information
set(gca,'Box','on');       
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2040s\Monthly_mean_flows_diff_RCM15_ID_',no,'.png');
...
clf %clears figure information
set(gca,'Box','on');       
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2040s\Monthly_mean_flows_diff_allRCM_ID_',no,'.png');
...
if exist(strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Station_',no,'_flows_2060s_monthly_vs_baseline.xls'), 'file')==2
   delete(strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Station_',no,'_flows_2060s_monthly_vs_baseline.xls'));
end
 
xlswrite(strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Station_',no,'_flows_2060s_monthly_vs_baseline.xls'),Table_monthly,'Sheet1','A2');
xlswrite(strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Station_',no,'_flows_2060s_monthly_vs_baseline.xls'),Table_monthly_header,'Sheet1','A1');
...
clf %clears figure information
set(gca,'Box','on');       
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2060s\Monthly_mean_flows_diff_RCM01_ID_',no,'.png');
...
clf %clears figure information
set(gca,'Box','on');       
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2060s\Monthly_mean_flows_diff_RCM04_ID_',no,'.png');
...
clf %clears figure information
set(gca,'Box','on');       
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2060s\Monthly_mean_flows_diff_RCM05_ID_',no,'.png');
...
clf %clears figure information
set(gca,'Box','on');       
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2060s\Monthly_mean_flows_diff_RCM06_ID_',no,'.png');
...
clf %clears figure information
set(gca,'Box','on');       
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2060s\Monthly_mean_flows_diff_RCM07_ID_',no,'.png');
...
clf %clears figure information
set(gca,'Box','on');       
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2060s\Monthly_mean_flows_diff_RCM08_ID_',no,'.png');
...
clf %clears figure information
set(gca,'Box','on');       
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2060s\Monthly_mean_flows_diff_RCM09_ID_',no,'.png');
...
clf %clears figure information
set(gca,'Box','on');       
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2060s\Monthly_mean_flows_diff_RCM10_ID_',no,'.png');
...
clf %clears figure information
set(gca,'Box','on');       
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2060s\Monthly_mean_flows_diff_RCM11_ID_',no,'.png');
...
clf %clears figure information
set(gca,'Box','on');       
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2060s\Monthly_mean_flows_diff_RCM12_ID_',no,'.png');
...
clf %clears figure information
set(gca,'Box','on');       
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2060s\Monthly_mean_flows_diff_RCM13_ID_',no,'.png');
...
clf %clears figure information
set(gca,'Box','on');       
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2060s\Monthly_mean_flows_diff_RCM15_ID_',no,'.png');
...
clf %clears figure information
set(gca,'Box','on');       
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2060s\Monthly_mean_flows_diff_allRCM_ID_',no,'.png');
...
if exist(strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Station_',no,'_flows_2040s_annual_vs_baseline.xls'), 'file')==2
   delete(strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Station_',no,'_flows_2040s_annual_vs_baseline.xls'));
end
 
xlswrite(strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Station_',no,'_flows_2040s_annual_vs_baseline.xls'),Table_annual,'Sheet1','A2');
xlswrite(strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Station_',no,'_flows_2040s_annual_vs_baseline.xls'),Table_annual_header,'Sheet1','A1');
...
clf %clears figure information
set(gca,'Box','on');       
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2040s\Annual_mean_flows_diff_RCM01_ID_',no,'.png');
...
clf %clears figure information
set(gca,'Box','on');
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2040s\Future_2040s_RCM01_bar_chart_annual_mean_flows_ID_',no,'.png');
...
clf %clears figure information
set(gca,'Box','on');       
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2040s\Annual_mean_flows_diff_RCM04_ID_',no,'.png');
...
clf %clears figure information
set(gca,'Box','on');
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2040s\Future_2040s_RCM04_bar_chart_annual_mean_flows_ID_',no,'.png');
...
clf %clears figure information
set(gca,'Box','on');       
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2040s\Annual_mean_flows_diff_RCM05_ID_',no,'.png');
...
clf %clears figure information
set(gca,'Box','on');
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2040s\Future_2040s_RCM05_bar_chart_annual_mean_flows_ID_',no,'.png');
...
clf %clears figure information
set(gca,'Box','on');       
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2040s\Annual_mean_flows_diff_RCM06_ID_',no,'.png');
...
clf %clears figure information
set(gca,'Box','on');
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2040s\Future_2040s_RCM06_bar_chart_annual_mean_flows_ID_',no,'.png');
...
clf %clears figure information
set(gca,'Box','on');       
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2040s\Annual_mean_flows_diff_RCM07_ID_',no,'.png');
...
clf %clears figure information
set(gca,'Box','on');
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2040s\Future_2040s_RCM07_bar_chart_annual_mean_flows_ID_',no,'.png');
...
clf %clears figure information
set(gca,'Box','on');       
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2040s\Annual_mean_flows_diff_RCM08_ID_',no,'.png');
...
clf %clears figure information
set(gca,'Box','on');
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2040s\Future_2040s_RCM08_bar_chart_annual_mean_flows_ID_',no,'.png');
...
clf %clears figure information
set(gca,'Box','on');       
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2040s\Annual_mean_flows_diff_RCM09_ID_',no,'.png');
...
clf %clears figure information
set(gca,'Box','on');
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2040s\Future_2040s_RCM09_bar_chart_annual_mean_flows_ID_',no,'.png');
...
clf %clears figure information
set(gca,'Box','on');       
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2040s\Annual_mean_flows_diff_RCM10_ID_',no,'.png');
...
clf %clears figure information
set(gca,'Box','on');
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2040s\Future_2040s_RCM10_bar_chart_annual_mean_flows_ID_',no,'.png');
...
clf %clears figure information
set(gca,'Box','on');       
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2040s\Annual_mean_flows_diff_RCM11_ID_',no,'.png');
...
clf %clears figure information
set(gca,'Box','on');
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2040s\Future_2040s_RCM11_bar_chart_annual_mean_flows_ID_',no,'.png');
...
clf %clears figure information
set(gca,'Box','on');       
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2040s\Annual_mean_flows_diff_RCM12_ID_',no,'.png');
...
clf %clears figure information
set(gca,'Box','on');
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2040s\Future_2040s_RCM12_bar_chart_annual_mean_flows_ID_',no,'.png');
...
clf %clears figure information
set(gca,'Box','on');       
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2040s\Annual_mean_flows_diff_RCM13_ID_',no,'.png');
...
clf %clears figure information
set(gca,'Box','on');
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2040s\Future_2040s_RCM13_bar_chart_annual_mean_flows_ID_',no,'.png');
...
clf %clears figure information
set(gca,'Box','on');       
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2040s\Annual_mean_flows_diff_RCM15_ID_',no,'.png');
...
clf %clears figure information
set(gca,'Box','on');
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2040s\Future_2040s_RCM15_bar_chart_annual_mean_flows_ID_',no,'.png');
...
clf %clears figure information
set(gca,'Box','on');       
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2040s\Annual_mean_flows_diff_allRCM_ID_',no,'.png');
...
clf %clears figure information
set(gca,'Box','on');
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2040s\Future_2040s_allRCM_bar_chart_annual_mean_flows_ID_',no,'.png');
...
if exist(strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Station_',no,'_flows_2060s_annual_vs_baseline.xls'), 'file')==2
   delete(strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Station_',no,'_flows_2060s_annual_vs_baseline.xls'));
end
 
xlswrite(strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Station_',no,'_flows_2060s_annual_vs_baseline.xls'),Table_annual,'Sheet1','A2');
xlswrite(strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Station_',no,'_flows_2060s_annual_vs_baseline.xls'),Table_annual_header,'Sheet1','A1');
...
clf %clears figure information
set(gca,'Box','on');       
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2060s\Annual_mean_flows_diff_RCM01_ID_',no,'.png');
...
clf %clears figure information
set(gca,'Box','on');
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2060s\Future_2060s_RCM01_bar_chart_annual_mean_flows_ID_',no,'.png');
...
clf %clears figure information
set(gca,'Box','on');       
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2060s\Annual_mean_flows_diff_RCM04_ID_',no,'.png');
...
clf %clears figure information
set(gca,'Box','on');
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2060s\Future_2060s_RCM04_bar_chart_annual_mean_flows_ID_',no,'.png');
...
clf %clears figure information
set(gca,'Box','on');       
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2060s\Annual_mean_flows_diff_RCM05_ID_',no,'.png');
...
clf %clears figure information
set(gca,'Box','on');
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2060s\Future_2060s_RCM05_bar_chart_annual_mean_flows_ID_',no,'.png');
...
clf %clears figure information
set(gca,'Box','on');       
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2060s\Annual_mean_flows_diff_RCM06_ID_',no,'.png');
...
clf %clears figure information
set(gca,'Box','on');
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2060s\Future_2060s_RCM06_bar_chart_annual_mean_flows_ID_',no,'.png');
...
clf %clears figure information
set(gca,'Box','on');       
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2060s\Annual_mean_flows_diff_RCM07_ID_',no,'.png');
...
clf %clears figure information
set(gca,'Box','on');
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2060s\Future_2060s_RCM07_bar_chart_annual_mean_flows_ID_',no,'.png');
...
clf %clears figure information
set(gca,'Box','on');       
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2060s\Annual_mean_flows_diff_RCM08_ID_',no,'.png');
...
clf %clears figure information
set(gca,'Box','on');
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2060s\Future_2060s_RCM08_bar_chart_annual_mean_flows_ID_',no,'.png');
...
clf %clears figure information
set(gca,'Box','on');       
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2060s\Annual_mean_flows_diff_RCM09_ID_',no,'.png');
...
clf %clears figure information
set(gca,'Box','on');
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2060s\Future_2060s_RCM09_bar_chart_annual_mean_flows_ID_',no,'.png');
...
clf %clears figure information
set(gca,'Box','on');       
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2060s\Annual_mean_flows_diff_RCM10_ID_',no,'.png');
...
clf %clears figure information
set(gca,'Box','on');
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2060s\Future_2060s_RCM10_bar_chart_annual_mean_flows_ID_',no,'.png');
...
clf %clears figure information
set(gca,'Box','on');       
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2060s\Annual_mean_flows_diff_RCM11_ID_',no,'.png');
...
clf %clears figure information
set(gca,'Box','on');
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2060s\Future_2060s_RCM11_bar_chart_annual_mean_flows_ID_',no,'.png');
...
clf %clears figure information
set(gca,'Box','on');       
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2060s\Annual_mean_flows_diff_RCM12_ID_',no,'.png');
...
clf %clears figure information
set(gca,'Box','on');
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2060s\Future_2060s_RCM12_bar_chart_annual_mean_flows_ID_',no,'.png');
...
clf %clears figure information
set(gca,'Box','on');       
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2060s\Annual_mean_flows_diff_RCM13_ID_',no,'.png');
...
clf %clears figure information
set(gca,'Box','on');
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2060s\Future_2060s_RCM13_bar_chart_annual_mean_flows_ID_',no,'.png');
...
clf %clears figure information
set(gca,'Box','on');       
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2060s\Annual_mean_flows_diff_RCM15_ID_',no,'.png');
...
clf %clears figure information
set(gca,'Box','on');
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2060s\Future_2060s_RCM15_bar_chart_annual_mean_flows_ID_',no,'.png');
...
clf %clears figure information
set(gca,'Box','on');       
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2060s\Annual_mean_flows_diff_allRCM_ID_',no,'.png');
...
clf %clears figure information
set(gca,'Box','on');
save_name_baseline=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Future_2060s\Future_2060s_allRCM_bar_chart_annual_mean_flows_ID_',no,'.png');
...
if exist(strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Station_',no,'_flows_2040s_allmonths_vs_baseline.xls'), 'file')==2
   delete(strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Station_',no,'_flows_2040s_allmonths_vs_baseline.xls'));
end
 
xlswrite(strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Station_',no,'_flows_2040s_allmonths_vs_baseline.xls'),Table_allmonths,'Sheet1','A2');
xlswrite(strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Station_',no,'_flows_2040s_allmonths_vs_baseline.xls'),Table_allmonths_header,'Sheet1','A1');
...
if exist(strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Station_',no,'_flows_2060s_allmonths_vs_baseline.xls'), 'file')==2
   delete(strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Station_',no,'_flows_2060s_allmonths_vs_baseline.xls'));
end
 
xlswrite(strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Station_',no,'_flows_2060s_allmonths_vs_baseline.xls'),Table_allmonths,'Sheet1','A2');
xlswrite(strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Station_',no,'_flows_2060s_allmonths_vs_baseline.xls'),Table_allmonths_header,'Sheet1','A1');
...
if exist(strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Station_',no,'_final_annual_vs_baseline_means.xls'), 'file')==2
   delete(strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Station_',no,'_final_annual_vs_bPDMaseline_means.xls'));
end
 
xlswrite(strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Station_',no,'_final_annual_vs_baseline_means.xls'),Table_final,'Sheet1','A2');
xlswrite(strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Station_',no,'_final_annual_vs_baseline_means.xls'),Table_final_header,'Sheet1','A1');
...
if exist(strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Station_',no,'_final_annual_vs_baseline_sum.xls'), 'file')==2
   delete(strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Station_',no,'_final_annual_vs_baseline_sum.xls'));
end
 
xlswrite(strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Station_',no,'_final_annual_vs_baseline_sum.xls'),Table_final,'Sheet1','A2');
xlswrite(strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\PDM_sim\Station_',no,'_final_annual_vs_baseline_sum.xls'),Table_final_header,'Sheet1','A1');
    %end
end