...
for i=1:length(GaugesNo)
    ...
    clf 
    set(gca,'Box','on');
    save_name=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\GR4J\Validate_flows\Obs_vs_sim_gauge_',no,'.png');
    ...
    save_name=strcat('H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\GR4J\Validate_flows\Obs_vs_sim_R2_gauge_',no,'.png');
    ...
    %end
    R_save_file='H:\01.PhD\004.Chapter4\00.Results\Flows\All_stations\GR4J\Validate_flows\R2_values_GR4J';
